<div class="cust_container">
    <h1 class="explore_article_header">Explore Homes on Easy Estate</h1>
    <div class="explore_header_content">
        <p class="explore_article_body">Explore Homes in the Washington Area, as well as read reviews from our previous clients. We showcase homes for purchase and rent.</p>
        <span class="explore_article_disclaimer">Disclaimer: All homes are built with Mock Data, and are not actually for sale.</span>
    </div>
    <div class="explore_cards">
        ...
        <div class="card_double">
            <div class="card_double_item">
                {{-- User Review Card --}}
                <div class="double_user_content">
                    <h5 class="double_user_header">EasyEstate User</h5>
                    <p class="double_user_name">Frankie D.</p>
                    <p class="double_user_review">I just moved into my new house 2 years ago and am loving it! The town is great, and the neighborhood is fantastic! Our...</p>
                </div>
        ...
        <div class="card_double card_double_user_reveiw">
            ...
            <div class="card_double_item">
                {{-- User Review Card --}}
                <div class="double_user_content_second">
                    <h5 class="double_user_header">EasyEstate User</h5>
                    <p class="double_user_name">Justin C.</p>
                    <p class="double_user_review">After years of searching I finally found the perfect home. It is in a great location and the home is in perfect condition. I am so...</p>
                </div>
                {{-- End User Reveiw Card --}}
            </div>
        </div>
        <div class="card_double">
            <div class="card_double_item">
