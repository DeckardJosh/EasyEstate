    ...
    <div class="help_container">
        <div class="help_item">
            ...
            <div class="help_item_button_wrapper">
                <a href="#" type="button" class="btn btn-success help_item_button">Find a home</a>
            </div>
        </div>
        <div class="help_item">
            <div class="help_item_image_wrapper">
            ...
            <div class="help_item_button_wrapper">
                <a href="#" type="button" class="btn btn-success help_item_button">Find a rental</a>
            </div>
        </div>
        <div class="help_item">
            <div class="help_item_image_wrapper">
            ...
            <div class="help_item_button_wrapper">
                <a href="#" type="button" class="btn btn-success help_item_button">Learn more</a>
            </div>
        </div>
    </div>
</div>
